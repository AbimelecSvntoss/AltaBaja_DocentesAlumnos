...
Module Program
    Sub Main(args As String())
        ...
        ''Cargar los alumnos del archivo de texto al iniciar el programa
        '' si el archivo existe, importar los docentes desde el archivo de texto
        If File.Exists("alumnoss.txt") Then
        ...
        Do
            ...
            Select Case opcion
                Case 1
                    ...
                    Select Case opcionDocente
                        Case 1
                            ...
                            Console.WriteLine("Docente agregado.")
                        ...
                        Case 2
                            ...
                            If docenteEditar IsNot Nothing Then
                                ...
                                Console.WriteLine("Docente actualizado.")
                                Console.WriteLine("Pulsa una tecla para continuar ...")
                                Console.ReadKey()
                            Else
                ...
                Case 2
                    ...
                    ''Mostrar el menu para gestionar alumnos
                    ...
                    Select Case opcionAlumno
                        Case 1
                            ...
                            Console.Write("Ingrese la materia del alumno:")
                        ...
                        Case 2
                            ...
                            Dim idEditar As Integer
                            idEditar = Convert.ToInt32(Console.ReadLine())
                            Dim alumnoEditar As Alumno = alumnos.Find(Function(d) d.Id = idEditar)
                            If alumnoEditar IsNot Nothing Then
                                ...
                                Console.WriteLine("Ingrese la nueva matricula del alumno: ")
                        ...
                        Case 3
                            Console.Clear()
                            Console.WriteLine("Eliminar Alumno (dar de baja)")
                            ...
                            Dim idEliminar As Integer
                            idEliminar = Convert.ToInt32(Console.ReadLine())
                            Dim alumnoEliminar As Alumno = alumnos.Find(Function(d) d.Id = idEliminar)
                        ...
                        Case 5
                            ...
                            Archivos.GuardarAlumnos(alumnos, "alumnos.txt")
                            Console.WriteLine("Alumnos almacenados en el acrhivo 'alumnos.txt'.")
                        Case Else
                            Console.WriteLine("Opción no válida. Por favor, seleccione una opción válida.")
                    End Select
          ' Aquí puedes implementar las opciones para agregar, editar, eliminar y mostrar alumnos
